...
set cpo&vim
map! <D-v> *
nnoremap <silent>  :call smoothie#backwards() 
nnoremap <silent>  :call smoothie#downwards() 
nnoremap <silent>  :call smoothie#forwards()  
map 	 w
nnoremap <silent>  :call smoothie#upwards()   
map - s<Down>
map M :make 
...
nnoremap <silent> <PageUp> :call smoothie#backwards() 
nnoremap <silent> <S-Up> :call smoothie#backwards() 
nnoremap <silent> <PageDown> :call smoothie#forwards()  
nnoremap <silent> <S-Down> :call smoothie#forwards()  
...
silent only
silent tabonly
cd ~/Documents/iOSResearch/fuzzing
